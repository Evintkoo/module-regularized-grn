...
\thanks{E-mail: evint.koo@gmail.com. Manuscript received 2026.}}
...
40\%, 50\%, 60\%, 70\%, 80\%, and 90\%). At each level, the lowest-importance neurons were
...
At 90\% sparsity, 51 neurons per tower are retained. The post-hoc AUROC is 0.8037 (retention 1.0027), matching the baseline within 0.02 AUROC points. After 10 epochs of fine-tuning at 90\% sparsity, AUROC rises to 0.8214 (retention 1.0248) --- the highest fine-tuned AUROC observed across all sparsity levels.
...
joint features that drive regulatory specificity, leading to the AUROC gap
...
is nominally available. This provides a mechanistic account of the C1 AUROC gap
that goes beyond simply noting that the cross-encoder has a more expressive
...
cost relative to a cross-encoder of comparable size; the 90\%-sparse
